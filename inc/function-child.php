...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko23', [
            'priority'    => 10,
            'title'       => esc_html__('Setting Toko 23', 'justg'),
...
if (!function_exists('justg_right_sidebar_check')) {
    function justg_right_sidebar_check()
    {
        ...
        echo '<div class="right-sidebar velocity-widget widget-area px-md-0 col-sm-12 col-md-3 order-lg-1 order-3 mt-3" id="right-sidebar" role="complementary">';
    ...
    <article <?php post_class('col-md-3 col-6 p-2 mb-3'); ?> id="post-<?php the_ID(); ?>">
        <div class="card h-100 card-product">
            ...
            <div class="p-3">
                ...
                <div class="row">
                    <div class="col-12 p-1 text-center"><a href="<?php the_permalink(); ?>" class="p-1 btn btn-sm bg-colortheme text-white w-100">Detail</a></div>
